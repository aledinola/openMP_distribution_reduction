...
contains
    ...
    subroutine solve_model
        ...
        use toolbox, only: tic, toc, fzero, settol_root

        implicit none
        real*8 :: excess_demand
        logical :: check
        ...
        !all fzero(x, asset_market, check)
        excess_demand = asset_market(r)
    ...
    subroutine initialize()
        ...
        use toolbox, only: discretize_AR, grid_Cons_Grow
